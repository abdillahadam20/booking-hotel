      ...
      <div className="hotel__container">
        {open && <div className="slider">
          ...
          <div className="slider__wrapper">
            <img src={photos[slide].src} alt="" className="slider__image" />
          </div>
        ...
        <div className="hotel__wrapper">
          ...
          <span className="hotel__price_highlight">Book a stay over $114 at this property and get a free airport taxi</span>
          <div className="hotel__images">
            {photos.map((photo, index) => (
              <div className="hotel__image__wrapper">
                <img onClick={() => handleOpen(index)} src={photo.src} alt="" className="hotel__image" />
              </div>
            ))}
          </div>
          <div className="hotel__details">
            <div className="hotel__details__text">
              ...
              <p className="hotel__descriptions">
